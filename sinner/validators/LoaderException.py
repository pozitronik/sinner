...
class LoadingException(Exception):
    ...
    def __str__(self) -> str:
        ...
        for error in self.errors:
            validation_errors.append(f"Parameter {Fore.YELLOW}--{error['attribute']}{Fore.RESET} {Fore.RED}{error['error']}{Fore.RESET} in module {Fore.CYAN}{error['module']}{Fore.RESET}")
