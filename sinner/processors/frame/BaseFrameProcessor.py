    ...
    def fill_initial_buffer(self, buffers: FrameBufferManager, buffer_name: str) -> None:
        with tqdm(
            ...
            for frame_num in self.handler:
                while buffers.b_len(buffer_name) > 10:
                    progress.set_postfix({
                        'buffer fill': buffers.b_len(buffer_name),
