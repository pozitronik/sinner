...
source_target_png_result: str = resolve_relative_path('data/targets/result-target.png', __file__)  # auto result name for image swap
source_target_mp4_result: str = resolve_relative_path('data/targets/result-target.mp4', __file__)  # auto result name for video swap
source_images_result: str = resolve_relative_path('data/result-images', __file__)  # auto result name for video swap
