...
male_face_jpg: str = resolve_relative_path('data/sources/male_face.jpg', __file__)
female_face_jpg: str = resolve_relative_path('data/sources/source.jpg', __file__)
multiple_faces_jpg: str = resolve_relative_path('data/sources/multiple_faces.jpg', __file__)
