...
def test_image_to_video_ffmpeg():
    ...
    extracted_frames_count = len([file for file in os.listdir(resolve_relative_path('data/targets/temp/FaceEnhancer/target.mp4/source.jpg/IN', __file__))])
    assert extracted_frames_count == 62
    swapped_frames_count = len([file for file in os.listdir(resolve_relative_path('data/targets/temp/FaceEnhancer/target.mp4/source.jpg/OUT', __file__))])
